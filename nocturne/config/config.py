# coding:utf-8
"""
config.py — Application configuration via qfluentwidgets QConfig.

Persisted settings (theme, DPI, language, blur radius), URL constants,
and the module-level ``cfg`` singleton (forced to DARK theme at import).
"""
